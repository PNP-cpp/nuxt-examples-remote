      ...
      const { customSafelistExtractor, generateSafelist } = require("/home/projects/nuxt-examples-rtbf9z/node_modules/@nuxt/ui/dist/runtime/utils/colors")
      ...
      module.exports = {
        ...
        content: {
          files: [
            "/home/projects/nuxt-examples-rtbf9z/node_modules/@nuxt/ui/dist/runtime/components/**/*.{vue,mjs,ts}",
            "/home/projects/nuxt-examples-rtbf9z/node_modules/@nuxt/ui/dist/runtime/ui.config/**/*.{mjs,js,ts}"
          ],
          transform: {
            vue: (content) => {
